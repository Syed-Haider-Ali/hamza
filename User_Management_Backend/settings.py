...
SECRET_KEY = 'django-insecure-q^_=l0cmp)+0jecfaxf5hr#0bla!=lr@p#@r4j5uev(&gear@*'
...
JWT_ENCODING_ALGO = os.getenv('JWT_ENCODING_ALGO')
JWT_ENCODING_SECRET_KEY = os.getenv('JWT_ENCODING_SECRET_KEY')
JWT_TOKEN_EXPIRY_DELTA = os.getenv('JWT_TOKEN_EXPIRY_DELTA')
